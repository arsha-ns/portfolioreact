            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 pb-4 pb-lg-0">
                        <img class="img-fluid rounded w-75" src={profilePicture} alt="" />
                    </div>
                    <div class="col-lg-7">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6 py-2"><h6>Address: <span class="text-secondary"></span></h6></div>
                            <div class="col-sm-6 py-2"><h6>Freelance: <span class="text-secondary"></span></h6></div>
                        </div>
